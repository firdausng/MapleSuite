...
public static class KafkaCloudNativeMessageExtension
{
    ...
    {
        return GetHeaderValue(message, SpecVersionKafkaHeader) is not null ||
    ...
    public static Message<string?, byte[]> ToKafkaMessage(this CloudEvent cloudEvent, ContentMode contentMode,
    ...
    private static Headers MapHeaders(this CloudEvent cloudEvent)
    {
